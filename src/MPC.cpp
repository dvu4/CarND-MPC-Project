...
const double k_cte = 4000;
const double k_epsi = 4000;
const double k_v= 1;

const double k_steering = 10;
const double k_throttle = 10;
const double k_steering_speed = 900;

const double k_diff_steering = 200;
const double k_diff_throttle = 200;
